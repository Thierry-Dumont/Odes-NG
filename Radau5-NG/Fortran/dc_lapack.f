...
C
   1  CONTINUE
C ---  B=IDENTITY, JACOBIAN A FULL MATRIX
c$$$      write(*,*) "Z1 debut slvrad",(z1(i),i=1,n)
c$$$      write(*,*) "Z2 debut slvrad",(z2(i),i=1,n)
c$$$      write(*,*) "Z3 debut slvrad",(z3(i),i=1,n)
c$$$      write(*,*) "F1 debut slvrad",(F1(i),i=1,n)
c$$$      write(*,*) "F2 debut slvrad",(F2(i),i=1,n)
c$$$      write(*,*) "F3 debut slvrad",(F3(i),i=1,n)
c$$$      write(*,*)"fac1 alphn betan",fac1,alphn,betan
      DO I=1,N
         S2=-F2(I)
         S3=-F3(I)
         Z1(I)=Z1(I)-F1(I)*FAC1
      ...
      DO I=N,1,-1
         ...
         Z2(2*I)=CONT(I)
      END DO
c$$$      write(*,*) "Z1 dans slvrad",(z1(i),i=1,n)
      CALL DGETRS ('No transpose',N,1,E1,LDE1,IP1,Z1,N,IER)
      CALL ZGETRS ('No transpose',N,1,E2R,LDE1,IP2,Z2,N,IER)
      ...
      DO I=1,N
         Z3(I)=CONT(I)
      END DO
c$$$      write(*,*) "Z1 fin slvrad",(z1(i),i=1,n)
c$$$      write(*,*) "Z2 fin slvrad",(z2(i),i=1,n)
c$$$      write(*,*) "Z3 fin slvrad",(z3(i),i=1,n)
      RETURN
C
C -----------------------------------------------------------
C
...
C
   1  CONTINUE
C ------  B=IDENTITY, JACOBIAN A FULL MATRIX
cc      write(*,*)"h= hee.. ",HEE1,HEE2,HEE3,DD1,DD2,DD3
      DO  I=1,N 
         F2(I)=HEE1*Z1(I)+HEE2*Z2(I)+HEE3*Z3(I)
         CONT(I)=F2(I)+Y0(I)
      END DO
c$$$      write(*,*) HEE1,HEE2,HEE3
c$$$      write(*,*) (Z1(i),i=1,n)
c$$$      write(*,*) (Z2(i),i=1,n)
c$$$      write(*,*) (Z3(i),i=1,n)
c$$$      stop
...
C
  77  CONTINUE
      ERR=0.D0
c$$$      write(*,*)"h= estrad CONT",(cont(i),i=1,n)
c$$$      write(*,*)"h= estrad scal",(scal(i),i=1,n)
      DO  I=1,N
