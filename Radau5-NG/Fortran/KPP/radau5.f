...
C                    SUBROUTINE SOLOUT (NR,XOLD,X,H,Y,CONT,LRC,N,
C                                       RPAR,IPAR,IRTRN)
...
C                 THE FUNCTION
C                        >>>   CONTR5(I,S,CONT,LRC,XSOL,HSOL)   <<<
...
C *** *** *** *** *** *** *** *** *** *** *** *** ***
      ...
      COMMON /CONRA5/NN,NN2,NN3,NN4,C2M1,C1M1,IPOSOL
      DIMENSION RPAR(*),IPAR(*)
...
C ---------- CONSTANTS ---------
      ...
      IF (IOUT.NE.0) THEN
          ...
          NSOLU=N
          HSOL=HOLD
          CALL SOLOUT(NRSOL,XOSOL,XSOL,HSOL,Y,CONT,LRC,N,
     &                RPAR,IPAR,IRTRN)
...
C ***********************************************************
C
      DOUBLE PRECISION FUNCTION CONTR5(I,X,CONT,LRC,XSOL,HSOL) 
C ----------------------------------------------------------
...
C ----------------------------------------------------------
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DIMENSION CONT(LRC)
      COMMON /CONAR5/NN,NN2,NN3,NN4,C2M1,C1M1,IPOSOL
      DIMENSION WORK(IPOSOL+1)
