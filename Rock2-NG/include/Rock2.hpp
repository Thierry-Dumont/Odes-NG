...
using namespace std;
///////////////////////////////////////////////////////////////////////////
/// A replacement for A. Abdulle rock2.f code for Rock2 method.
///
/// Template arguments:
...
//////////////////////////////////////////////////////////////////////////
namespace odes {
  template<class Fonc> class Rock2
  {
  ...
  public:
    //! constructor
    //! \param  F RHS.
    Rock2(Fonc& F): Fp(&F),size(Fp->size())
    {
      ...
      while(t<tend)
	{
	  ...
	  if (h<10.0e0*uround)
	    throw OdesException("Rock2: step too small h=",h,"limit:",
				     10.0e0*uround);
	  if(nrho==0)
	    eigmax=F.rho();
