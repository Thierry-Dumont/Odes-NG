#ifndef ToolSequential__h
#define ToolSequential__h
#include <iostream>
...
namespace odes {
  ///////////////////////////////////////////////////////////////////////////
  /// Perform basic operations for Rock4. This is the sequential (but
  /// vectorized) case.
  ///
  /// !VEC annotation means that the loop as proved to be vectorizable.
  //////////////////////////////////////////////////////////////////////////
  template<class Fonc> class ToolSequential
  {
  ...
  public:
    ...
    //! \param h time step.
    ToolSequential(int _mr,int _mz,int _size,double _h):
